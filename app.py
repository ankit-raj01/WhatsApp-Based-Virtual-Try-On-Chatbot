...
#         # elif 'human_image' in user_data[sender_id] and 'garment_image' in user_data[sender_id]:
#             human_image_path = download_image(user_data[sender_id]['human_image'])
#             garment_image_path = download_image(user_data[sender_id]['garment_image'])
...
#                 )
#             else:
#                 response.message("There was an issue processing the images. Please try again.")
